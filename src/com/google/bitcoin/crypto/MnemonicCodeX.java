...
/**
 * A MnemonicCodeX object may be used to convert between binary seed values and
 * lists of words per <a href="https://en.bitcoin.it/wiki/BIP_0039">the BIP 39
 * specification</a>
 */

public class MnemonicCodeX {
    ...
    public MnemonicCodeX() throws IOException {
        this(MnemonicCodeX.class.getResourceAsStream("mnemonic/wordlist/english.txt"), BIP39_ENGLISH_SHA256);
    }

    /**
     * Creates an MnemonicCodeX object, initializing with words read from the supplied input stream.  If a wordListDigest
     * is supplied the digest of the words will be checked.
     */
    public MnemonicCodeX(InputStream wordstream, String wordListDigest) throws IOException, IllegalArgumentException {
